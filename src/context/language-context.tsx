...
const translations = {
    EN: {
        ...
        alert_location_error: 'Could not get your location. Please ensure you have enabled location services and are using a secure connection (HTTPS). Requesting high accuracy.',
        ...
        financial_overview_subtitle: 'Revenue vs costs over the last 6 months.',
        transaction_history: 'Transaction History',
        transaction_history_subtitle: 'A detailed log of all income and expenses.',
    ...
    PT: {
        ...
        income: 'Receita',
        expense: 'Despesa',
        "Client Payment": "Pagamento de Cliente",
        Fuel: 'Combustível',
        Salaries: 'Salários',
        ...
        alert_location_error: 'Não foi possível obter a sua localização. Por favor, certifique-se de que ativou os serviços de localização e está a usar uma conexão segura (HTTPS). A solicitar alta precisão.',
        ...
        financial_overview_subtitle: 'Receitas vs. custos nos últimos 6 meses.',
        transaction_history: 'Histórico de Transações',
        transaction_history_subtitle: 'Um registo detalhado de todas as receitas e despesas.',
